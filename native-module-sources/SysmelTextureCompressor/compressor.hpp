#ifndef SYSMEL_TEXTURE_COMPRESSOR_HPP
#define SYSMEL_TEXTURE_COMPRESSOR_HPP
...
extern "C" bool sysmel_textureCompressor_compressTextureSlice(
...
extern "C" bool sysmel_textureCompressor_decompressTextureSlice(
    uint32_t width, uint32_t height, PixelFormat sourceFormat, int32_t sourcePitch, const uint8_t *sourcePixels,
    PixelFormat destFormat, int32_t destPitch, uint8_t *destPixels);
} // End of namespace SysmelTextureCompressor

#endif //SYSMEL_TEXTURE_COMPRESSOR_HPP
